...
Eigen::MatrixXd trielement_formulation::compute_trielement_stiffness_matrix(
...
Eigen::MatrixXd trielement_formulation::compute_trielement_mass_matrix(
	const std::vector<Eigen::Vector2d>& node_coords,
	const material_store& element_material)
{
	// Returns the (2n x 2n) 
...
Eigen::Matrix2d trielement_formulation::compute_jacobian(const std::vector<Eigen::Vector2d>& node_coords,
...
Eigen::MatrixXd trielement_formulation::compute_B_matrix(const Eigen::Matrix2d& J_inv,
	const std::vector<std::pair<double, double>>& dN)
{
